 ...
 * This script handles the functionality for the Curis Privacy Policy page including:
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateDarkModeIcon(isDarkMode) {
        ...
        // This function is here for any additional icon updates if needed
    }
    ...
    function createTableOfContents() {
        ...
        mainSections.forEach((section) => {
            ...
            if (section.id === 'privacy-policy-hero') return;
    ...
    /**
     * Adds visual highlighting to sections when they're hovered
     */
