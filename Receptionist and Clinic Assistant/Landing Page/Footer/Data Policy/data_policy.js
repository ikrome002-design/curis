/**
 * Curis by Citrus - Data Policy Page JavaScript
 * 
 * This script handles all interactive functionality for the Data Policy page:
...
function initNavigation() {
    ...
    const navItems = [
        ...
        { title: 'How We Use Data', link: '#data-use' },
        { title: 'Data Security', link: '#data-security' },
        { title: 'Data Access Rights', link: '#user-rights' },
...
function initSecondaryNavigation() {
    ...
    sections.forEach(section => {
        ...
        if (subsections.length > 0) {
            ...
            subsections.forEach(subsection => {
                // Get subsection ID if exists, or create one
