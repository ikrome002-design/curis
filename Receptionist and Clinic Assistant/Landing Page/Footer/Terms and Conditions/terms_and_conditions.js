/**
 * Curis by Citrus - Terms and Conditions Page JavaScript
 * 
 * This script handles all interactive functionality for the Terms and Conditions page:
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Make Terms Subsections Interactive
    ...
    // Add interactive copy section links
    addSectionLinkCopy();
});
...
function initNavigation() {
    ...
    const navItems = [
        ...
        { title: 'Purpose of Service', link: '#purpose-of-service' },
        { title: 'Definitions', link: '#definitions' },
        { title: 'Account Terms', link: '#account-terms' },
        { title: 'Use of Services', link: '#service-terms' },
        { title: 'Your Responsibilities', link: '#user-responsibilities' },
        { title: 'Platform Limitations', link: '#limitations' },
        { title: 'Termination & Access', link: '#termination-rights' },
        { title: 'Changes to Terms', link: '#change-terms' },
...
/**
 * Function to make terms subsections interactive
 * On mobile, makes subsections expandable
 */
function initSubsectionInteractivity() {
    const subsections = document.querySelectorAll('.terms-subsection');
...
function addDynamicStyles() {
    ...
    style.textContent = `
        ...
        @media (max-width: 768px) {
            .terms-subsection:not(.expanded) > *:not(h3) {
                display: none;
            }
            
            .terms-subsection.expanded > *:not(h3) {
                display: block;
        ...
        @media print {
            .nav-list, .hamburger-menu, .toc-container, .secondary-nav {
...
function initSecondaryNavigation() {
    ...
    sections.forEach(section => {
        ...
        const subsections = section.querySelectorAll('.terms-subsection');
    ...
    window.addEventListener('scroll', () => {
        ...
        if (scrollTop > document.querySelector('.terms-header').offsetHeight) {
...
function enhanceAccessibility() {
    ...
    // Add roles and aria attributes to interactive elements
    document.querySelectorAll('.terms-subsection').forEach(subsection => {
        subsection.setAttribute('role', 'region');
    });
}

/**
 * Initialize table of contents for the page
 */
function initTableOfContents() {
    ...
    // Insert after terms header
    const termsHeader = document.querySelector('.terms-header');
    termsHeader.after(tocContainer);
